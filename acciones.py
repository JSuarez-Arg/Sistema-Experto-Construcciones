...
# Carga la base de conocimientos desde "construccion.json" al iniciar Base_de_Conocimiento_Construccion
try:
    engine.base.from_json("construccion.json")
    print("Base de conocimientos 'construccion.json' cargada exitosamente.")
